        ...
        <>
            <div className="w-full gap-2 flex justify-between items-center p-6 flex-col lg:flex-row">
                <div className="flex gap-2 items-center order-last lg:order-first">
                    ...
                    <CheckboxGroup
                        aria-label="Select mission state"
                        className="gap-1"
                        orientation="horizontal"
                        value={["active"]}
                    >
                        <TagGroupItem value="active">Active</TagGroupItem>
                        <TagGroupItem value="completed">Completed</TagGroupItem>
                        <TagGroupItem value="abandoned">Abandoned</TagGroupItem>
                    </CheckboxGroup>
                </div>
                <Input
                    placeholder="Search..."
                    ...
                    isClearable={true}
                    startContent={<Icon icon="fluent:search-24-filled" className="w-6 h-6 pointer-events-none" />}
                />
            </div>
