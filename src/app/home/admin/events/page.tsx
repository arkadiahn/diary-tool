...
import { getEvents, Event } from '@/api/missionboard';
...
const CustomActionsComponent = (props: any) => {
	return (
		<div className="flex gap-2 items-center justify-center h-full">
			<Button size="sm" onPress={() => props.onEditEvent(props.data)}>Edit</Button>
			...
			<div className="h-[400px] max-w-6xl w-full">
				<AgGridReact
					...
					columnDefs={[
						...
						{ headerName: "Actions", cellRenderer: CustomActionsComponent, cellRendererParams: { onEditEvent: handleEditEvent }, minWidth: 100 },
					]}
					defaultColDef={{
						editable: false,
						flex: 1,
