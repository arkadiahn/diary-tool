		...
		>
			...
			<div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
				<DatePicker
					...
					label="Start Time"
					name="begin_time"
					defaultValue={selectedEvent?.begin_time ? parseAbsolute(selectedEvent.begin_time, "Europe/Berlin") : null}
				...
				<DatePicker
					...
					label="End Time"
					name="end_time"
					defaultValue={selectedEvent?.end_time ? parseAbsolute(selectedEvent.end_time, "Europe/Berlin") : null}
					placeholderValue={now("Europe/Berlin")}
					isRequired={true}
				/>
			</div>
