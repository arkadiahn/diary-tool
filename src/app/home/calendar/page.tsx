...
import { Button, Checkbox, CheckboxGroup, Input, Popover, PopoverContent, PopoverTrigger, ScrollShadow } from "@heroui/react";
...
export default async function CalendarPage() {
    ...
    return (
        <MainPageLayout title="Calendar" description="Find your next event" headerItems={
			<>
